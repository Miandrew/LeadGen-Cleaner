...
const PLANS = [
  {
    ...
    period: '/month',
    leads: 3,
    features: ['3 leads delivered automatically per month', 'No per-lead payment required'],
    popular: false,
  },
  {
    id: 'growth',
    ...
    period: '/month',
    leads: 8,
    features: ['8 leads delivered automatically per month', 'No per-lead payment required', 'Featured badge on your listing'],
    popular: true,
  },
  {
    id: 'unlimited',
    ...
    period: '/month',
    leads: 999,
    features: ['All leads in your state delivered automatically', 'First priority on all new leads'],
    popular: false,
  },
]
